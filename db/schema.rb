...
ActiveRecord::Schema.define(version: 2021_12_30_064535) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["fixed_cost_id"], name: "index_categories_on_fixed_cost_id"
  ...
  add_foreign_key "categories", "fixed_costs"
